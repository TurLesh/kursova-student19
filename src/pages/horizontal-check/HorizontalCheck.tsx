...
import './HorizontalCheckStyle.css';
...
const HorizontalCheck = () => {
    ...
    //matrix row 1 x generic columns states
    ...
    // matrix row 2 x generic columns states
    ...
    // matrix row 3 x generic columns states
    ...
    // matrix row 4 x generic columns states
    ...
    // matrix row 5 x generic columns states
    ...
    // matrix row 6 x generic columns states
    ...
    // matrix row 7 x generic columns states
    ...
    // matrix row 8 x generic columns states
    ...
    // matrix row 9 x generic columns states
    ...
    const doCheckBtnHandler = () => {
        ...
        let generic5Arr = genericColumnsArr[4];

        let matrixRowsArr = readMatrix();
        let row1Arr = matrixRowsArr[0];
        let row2Arr = matrixRowsArr[1];
        let row3Arr = matrixRowsArr[2];
        let row4Arr = matrixRowsArr[3];
        let row5Arr = matrixRowsArr[4];
        let row6Arr = matrixRowsArr[5];
        let row7Arr = matrixRowsArr[6];
        let row8Arr = matrixRowsArr[7];
        let row9Arr = matrixRowsArr[8];

        console.log('Generic columns: ', genericColumnsArr);
        console.log('Matrix rows: ', matrixRowsArr);

        // 1 x 1
        if (row1Arr[0] === generic1Arr[0] && row1Arr[0] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[1] === generic1Arr[1] && row1Arr[1] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[2] === generic1Arr[2] && row1Arr[2] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[3] === generic1Arr[3] && row1Arr[3] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[4] === generic1Arr[4] && row1Arr[4] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[5] === generic1Arr[5] && row1Arr[5] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[6] === generic1Arr[6] && row1Arr[6] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[7] === generic1Arr[7] && row1Arr[7] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[8] === generic1Arr[8] && row1Arr[8] === 1) {
            setNumberOfCoincidences1x1((prevNumber) => prevNumber + 1);
        }

        // 1 x 2
        if (row1Arr[0] === generic2Arr[0] && row1Arr[0] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[1] === generic2Arr[1] && row1Arr[1] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[2] === generic2Arr[2] && row1Arr[2] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[3] === generic2Arr[3] && row1Arr[3] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[4] === generic2Arr[4] && row1Arr[4] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[5] === generic2Arr[5] && row1Arr[5] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[6] === generic2Arr[6] && row1Arr[6] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[7] === generic2Arr[7] && row1Arr[7] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[8] === generic2Arr[8] && row1Arr[8] === 1) {
            setNumberOfCoincidences1x2((prevNumber) => prevNumber + 1);
        }

        // 1 x 3
        if (row1Arr[0] === generic3Arr[0] && row1Arr[0] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[1] === generic3Arr[1] && row1Arr[1] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[2] === generic3Arr[2] && row1Arr[2] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[3] === generic3Arr[3] && row1Arr[3] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[4] === generic3Arr[4] && row1Arr[4] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[5] === generic3Arr[5] && row1Arr[5] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[6] === generic3Arr[6] && row1Arr[6] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[7] === generic3Arr[7] && row1Arr[7] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[8] === generic3Arr[8] && row1Arr[8] === 1) {
            setNumberOfCoincidences1x3((prevNumber) => prevNumber + 1);
        }

        // 1 x 4
        if (row1Arr[0] === generic4Arr[0] && row1Arr[0] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[1] === generic4Arr[1] && row1Arr[1] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[2] === generic4Arr[2] && row1Arr[2] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[3] === generic4Arr[3] && row1Arr[3] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[4] === generic4Arr[4] && row1Arr[4] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[5] === generic4Arr[5] && row1Arr[5] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[6] === generic4Arr[6] && row1Arr[6] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[7] === generic4Arr[7] && row1Arr[7] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[8] === generic4Arr[8] && row1Arr[8] === 1) {
            setNumberOfCoincidences1x4((prevNumber) => prevNumber + 1);
        }

        // 1 x 5
        if (row1Arr[0] === generic5Arr[0] && row1Arr[0] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[1] === generic5Arr[1] && row1Arr[1] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[2] === generic5Arr[2] && row1Arr[2] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[3] === generic5Arr[3] && row1Arr[3] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[4] === generic5Arr[4] && row1Arr[4] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[5] === generic5Arr[5] && row1Arr[5] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[6] === generic5Arr[6] && row1Arr[6] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[7] === generic5Arr[7] && row1Arr[7] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }
        if (row1Arr[8] === generic5Arr[8] && row1Arr[8] === 1) {
            setNumberOfCoincidences1x5((prevNumber) => prevNumber + 1);
        }

        // 2 x 1
        if (row2Arr[0] === generic1Arr[0] && row2Arr[0] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[1] === generic1Arr[1] && row2Arr[1] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[2] === generic1Arr[2] && row2Arr[2] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[3] === generic1Arr[3] && row2Arr[3] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[4] === generic1Arr[4] && row2Arr[4] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[5] === generic1Arr[5] && row2Arr[5] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[6] === generic1Arr[6] && row2Arr[6] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[7] === generic1Arr[7] && row2Arr[7] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[8] === generic1Arr[8] && row2Arr[8] === 1) {
            setNumberOfCoincidences2x1((prevNumber) => prevNumber + 1);
        }

        // 2 x 2
        if (row2Arr[0] === generic2Arr[0] && row2Arr[0] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[1] === generic2Arr[1] && row2Arr[1] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[2] === generic2Arr[2] && row2Arr[2] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[3] === generic2Arr[3] && row2Arr[3] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[4] === generic2Arr[4] && row2Arr[4] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[5] === generic2Arr[5] && row2Arr[5] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[6] === generic2Arr[6] && row2Arr[6] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[7] === generic2Arr[7] && row2Arr[7] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[8] === generic2Arr[8] && row2Arr[8] === 1) {
            setNumberOfCoincidences2x2((prevNumber) => prevNumber + 1);
        }

        // 2 x 3
        if (row2Arr[0] === generic3Arr[0] && row2Arr[0] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[1] === generic3Arr[1] && row2Arr[1] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[2] === generic3Arr[2] && row2Arr[2] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[3] === generic3Arr[3] && row2Arr[3] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[4] === generic3Arr[4] && row2Arr[4] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[5] === generic3Arr[5] && row2Arr[5] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[6] === generic3Arr[6] && row2Arr[6] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[7] === generic3Arr[7] && row2Arr[7] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[8] === generic3Arr[8] && row2Arr[8] === 1) {
            setNumberOfCoincidences2x3((prevNumber) => prevNumber + 1);
        }

        // 2 x 4
        if (row2Arr[0] === generic4Arr[0] && row2Arr[0] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[1] === generic4Arr[1] && row2Arr[1] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[2] === generic4Arr[2] && row2Arr[2] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[3] === generic4Arr[3] && row2Arr[3] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[4] === generic4Arr[4] && row2Arr[4] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[5] === generic4Arr[5] && row2Arr[5] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[6] === generic4Arr[6] && row2Arr[6] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[7] === generic4Arr[7] && row2Arr[7] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[8] === generic4Arr[8] && row2Arr[8] === 1) {
            setNumberOfCoincidences2x4((prevNumber) => prevNumber + 1);
        }

        // 2 x 5
        if (row2Arr[0] === generic5Arr[0] && row2Arr[0] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[1] === generic5Arr[1] && row2Arr[1] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[2] === generic5Arr[2] && row2Arr[2] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[3] === generic5Arr[3] && row2Arr[3] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[4] === generic5Arr[4] && row2Arr[4] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[5] === generic5Arr[5] && row2Arr[5] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[6] === generic5Arr[6] && row2Arr[6] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[7] === generic5Arr[7] && row2Arr[7] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }
        if (row2Arr[8] === generic5Arr[8] && row2Arr[8] === 1) {
            setNumberOfCoincidences2x5((prevNumber) => prevNumber + 1);
        }

        // 3 x 1
        if (row3Arr[0] === generic1Arr[0] && row3Arr[0] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[1] === generic1Arr[1] && row3Arr[1] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[2] === generic1Arr[2] && row3Arr[2] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[3] === generic1Arr[3] && row3Arr[3] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[4] === generic1Arr[4] && row3Arr[4] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[5] === generic1Arr[5] && row3Arr[5] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[6] === generic1Arr[6] && row3Arr[6] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[7] === generic1Arr[7] && row3Arr[7] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[8] === generic1Arr[8] && row3Arr[8] === 1) {
            setNumberOfCoincidences3x1((prevNumber) => prevNumber + 1);
        }

        // 3 x 2
        if (row3Arr[0] === generic2Arr[0] && row3Arr[0] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[1] === generic2Arr[1] && row3Arr[1] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[2] === generic2Arr[2] && row3Arr[2] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[3] === generic2Arr[3] && row3Arr[3] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[4] === generic2Arr[4] && row3Arr[4] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[5] === generic2Arr[5] && row3Arr[5] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[6] === generic2Arr[6] && row3Arr[6] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[7] === generic2Arr[7] && row3Arr[7] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[8] === generic2Arr[8] && row3Arr[8] === 1) {
            setNumberOfCoincidences3x2((prevNumber) => prevNumber + 1);
        }

        // 3 x 3
        if (row3Arr[0] === generic3Arr[0] && row3Arr[0] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[1] === generic3Arr[1] && row3Arr[1] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[2] === generic3Arr[2] && row3Arr[2] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[3] === generic3Arr[3] && row3Arr[3] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[4] === generic3Arr[4] && row3Arr[4] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[5] === generic3Arr[5] && row3Arr[5] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[6] === generic3Arr[6] && row3Arr[6] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[7] === generic3Arr[7] && row3Arr[7] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[8] === generic3Arr[8] && row3Arr[8] === 1) {
            setNumberOfCoincidences3x3((prevNumber) => prevNumber + 1);
        }

        // 3 x 4
        if (row3Arr[0] === generic4Arr[0] && row3Arr[0] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[1] === generic4Arr[1] && row3Arr[1] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[2] === generic4Arr[2] && row3Arr[2] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[3] === generic4Arr[3] && row3Arr[3] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[4] === generic4Arr[4] && row3Arr[4] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[5] === generic4Arr[5] && row3Arr[5] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[6] === generic4Arr[6] && row3Arr[6] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[7] === generic4Arr[7] && row3Arr[7] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[8] === generic4Arr[8] && row3Arr[8] === 1) {
            setNumberOfCoincidences3x4((prevNumber) => prevNumber + 1);
        }

        // 3 x 5
        if (row3Arr[0] === generic5Arr[0] && row3Arr[0] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[1] === generic5Arr[1] && row3Arr[1] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[2] === generic5Arr[2] && row3Arr[2] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[3] === generic5Arr[3] && row3Arr[3] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[4] === generic5Arr[4] && row3Arr[4] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[5] === generic5Arr[5] && row3Arr[5] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[6] === generic5Arr[6] && row3Arr[6] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[7] === generic5Arr[7] && row3Arr[7] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }
        if (row3Arr[8] === generic5Arr[8] && row3Arr[8] === 1) {
            setNumberOfCoincidences3x5((prevNumber) => prevNumber + 1);
        }

        // 4 x 1
        if (row4Arr[0] === generic1Arr[0] && row4Arr[0] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[1] === generic1Arr[1] && row4Arr[1] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[2] === generic1Arr[2] && row4Arr[2] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[3] === generic1Arr[3] && row4Arr[3] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[4] === generic1Arr[4] && row4Arr[4] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[5] === generic1Arr[5] && row4Arr[5] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[6] === generic1Arr[6] && row4Arr[6] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[7] === generic1Arr[7] && row4Arr[7] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[8] === generic1Arr[8] && row4Arr[8] === 1) {
            setNumberOfCoincidences4x1((prevNumber) => prevNumber + 1);
        }

        // 4 x 2
        if (row4Arr[0] === generic2Arr[0] && row4Arr[0] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[1] === generic2Arr[1] && row4Arr[1] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[2] === generic2Arr[2] && row4Arr[2] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[3] === generic2Arr[3] && row4Arr[3] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[4] === generic2Arr[4] && row4Arr[4] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[5] === generic2Arr[5] && row4Arr[5] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[6] === generic2Arr[6] && row4Arr[6] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[7] === generic2Arr[7] && row4Arr[7] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[8] === generic2Arr[8] && row4Arr[8] === 1) {
            setNumberOfCoincidences4x2((prevNumber) => prevNumber + 1);
        }

        // 4 x 3
        if (row4Arr[0] === generic3Arr[0] && row4Arr[0] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[1] === generic3Arr[1] && row4Arr[1] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[2] === generic3Arr[2] && row4Arr[2] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[3] === generic3Arr[3] && row4Arr[3] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[4] === generic3Arr[4] && row4Arr[4] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[5] === generic3Arr[5] && row4Arr[5] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[6] === generic3Arr[6] && row4Arr[6] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[7] === generic3Arr[7] && row4Arr[7] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[8] === generic3Arr[8] && row4Arr[8] === 1) {
            setNumberOfCoincidences4x3((prevNumber) => prevNumber + 1);
        }

        // 4 x 4
        if (row4Arr[0] === generic4Arr[0] && row4Arr[0] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[1] === generic4Arr[1] && row4Arr[1] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[2] === generic4Arr[2] && row4Arr[2] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[3] === generic4Arr[3] && row4Arr[3] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[4] === generic4Arr[4] && row4Arr[4] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[5] === generic4Arr[5] && row4Arr[5] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[6] === generic4Arr[6] && row4Arr[6] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[7] === generic4Arr[7] && row4Arr[7] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[8] === generic4Arr[8] && row4Arr[8] === 1) {
            setNumberOfCoincidences4x4((prevNumber) => prevNumber + 1);
        }

        // 4 x 5
        if (row4Arr[0] === generic5Arr[0] && row4Arr[0] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[1] === generic5Arr[1] && row4Arr[1] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[2] === generic5Arr[2] && row4Arr[2] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[3] === generic5Arr[3] && row4Arr[3] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[4] === generic5Arr[4] && row4Arr[4] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[5] === generic5Arr[5] && row4Arr[5] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[6] === generic5Arr[6] && row4Arr[6] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[7] === generic5Arr[7] && row4Arr[7] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }
        if (row4Arr[8] === generic5Arr[8] && row4Arr[8] === 1) {
            setNumberOfCoincidences4x5((prevNumber) => prevNumber + 1);
        }

        // 5 x 1
        if (row5Arr[0] === generic1Arr[0] && row5Arr[0] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[1] === generic1Arr[1] && row5Arr[1] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[2] === generic1Arr[2] && row5Arr[2] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[3] === generic1Arr[3] && row5Arr[3] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[4] === generic1Arr[4] && row5Arr[4] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[5] === generic1Arr[5] && row5Arr[5] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[6] === generic1Arr[6] && row5Arr[6] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[7] === generic1Arr[7] && row5Arr[7] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[8] === generic1Arr[8] && row5Arr[8] === 1) {
            setNumberOfCoincidences5x1((prevNumber) => prevNumber + 1);
        }

        // 5 x 2
        if (row5Arr[0] === generic2Arr[0] && row5Arr[0] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[1] === generic2Arr[1] && row5Arr[1] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[2] === generic2Arr[2] && row5Arr[2] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[3] === generic2Arr[3] && row5Arr[3] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[4] === generic2Arr[4] && row5Arr[4] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[5] === generic2Arr[5] && row5Arr[5] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[6] === generic2Arr[6] && row5Arr[6] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[7] === generic2Arr[7] && row5Arr[7] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[8] === generic2Arr[8] && row5Arr[8] === 1) {
            setNumberOfCoincidences5x2((prevNumber) => prevNumber + 1);
        }

        // 5 x 3
        if (row5Arr[0] === generic3Arr[0] && row5Arr[0] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[1] === generic3Arr[1] && row5Arr[1] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[2] === generic3Arr[2] && row5Arr[2] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[3] === generic3Arr[3] && row5Arr[3] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[4] === generic3Arr[4] && row5Arr[4] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[5] === generic3Arr[5] && row5Arr[5] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[6] === generic3Arr[6] && row5Arr[6] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[7] === generic3Arr[7] && row5Arr[7] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[8] === generic3Arr[8] && row5Arr[8] === 1) {
            setNumberOfCoincidences5x3((prevNumber) => prevNumber + 1);
        }

        // 5 x 4
        if (row5Arr[0] === generic4Arr[0] && row5Arr[0] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[1] === generic4Arr[1] && row5Arr[1] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[2] === generic4Arr[2] && row5Arr[2] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[3] === generic4Arr[3] && row5Arr[3] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[4] === generic4Arr[4] && row5Arr[4] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[5] === generic4Arr[5] && row5Arr[5] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[6] === generic4Arr[6] && row5Arr[6] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[7] === generic4Arr[7] && row5Arr[7] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[8] === generic4Arr[8] && row5Arr[8] === 1) {
            setNumberOfCoincidences5x4((prevNumber) => prevNumber + 1);
        }

        // 5 x 5
        if (row5Arr[0] === generic5Arr[0] && row5Arr[0] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[1] === generic5Arr[1] && row5Arr[1] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[2] === generic5Arr[2] && row5Arr[2] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[3] === generic5Arr[3] && row5Arr[3] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[4] === generic5Arr[4] && row5Arr[4] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[5] === generic5Arr[5] && row5Arr[5] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[6] === generic5Arr[6] && row5Arr[6] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[7] === generic5Arr[7] && row5Arr[7] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }
        if (row5Arr[8] === generic5Arr[8] && row5Arr[8] === 1) {
            setNumberOfCoincidences5x5((prevNumber) => prevNumber + 1);
        }

        // 6 x 1
        if (row6Arr[0] === generic1Arr[0] && row6Arr[0] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[1] === generic1Arr[1] && row6Arr[1] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[2] === generic1Arr[2] && row6Arr[2] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[3] === generic1Arr[3] && row6Arr[3] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[4] === generic1Arr[4] && row6Arr[4] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[5] === generic1Arr[5] && row6Arr[5] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[6] === generic1Arr[6] && row6Arr[6] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[7] === generic1Arr[7] && row6Arr[7] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[8] === generic1Arr[8] && row6Arr[8] === 1) {
            setNumberOfCoincidences6x1((prevNumber) => prevNumber + 1);
        }

        // 6 x 2
        if (row6Arr[0] === generic2Arr[0] && row6Arr[0] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[1] === generic2Arr[1] && row6Arr[1] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[2] === generic2Arr[2] && row6Arr[2] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[3] === generic2Arr[3] && row6Arr[3] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[4] === generic2Arr[4] && row6Arr[4] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[5] === generic2Arr[5] && row6Arr[5] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[6] === generic2Arr[6] && row6Arr[6] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[7] === generic2Arr[7] && row6Arr[7] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[8] === generic2Arr[8] && row6Arr[8] === 1) {
            setNumberOfCoincidences6x2((prevNumber) => prevNumber + 1);
        }

        // 6 x 3
        if (row6Arr[0] === generic3Arr[0] && row6Arr[0] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[1] === generic3Arr[1] && row6Arr[1] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[2] === generic3Arr[2] && row6Arr[2] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[3] === generic3Arr[3] && row6Arr[3] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[4] === generic3Arr[4] && row6Arr[4] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[5] === generic3Arr[5] && row6Arr[5] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[6] === generic3Arr[6] && row6Arr[6] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[7] === generic3Arr[7] && row6Arr[7] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[8] === generic3Arr[8] && row6Arr[8] === 1) {
            setNumberOfCoincidences6x3((prevNumber) => prevNumber + 1);
        }

        // 6 x 4
        if (row6Arr[0] === generic4Arr[0] && row6Arr[0] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[1] === generic4Arr[1] && row6Arr[1] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[2] === generic4Arr[2] && row6Arr[2] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[3] === generic4Arr[3] && row6Arr[3] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[4] === generic4Arr[4] && row6Arr[4] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[5] === generic4Arr[5] && row6Arr[5] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[6] === generic4Arr[6] && row6Arr[6] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[7] === generic4Arr[7] && row6Arr[7] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[8] === generic4Arr[8] && row6Arr[8] === 1) {
            setNumberOfCoincidences6x4((prevNumber) => prevNumber + 1);
        }

        // 6 x 5
        if (row6Arr[0] === generic5Arr[0] && row6Arr[0] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[1] === generic5Arr[1] && row6Arr[1] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[2] === generic5Arr[2] && row6Arr[2] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[3] === generic5Arr[3] && row6Arr[3] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[4] === generic5Arr[4] && row6Arr[4] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[5] === generic5Arr[5] && row6Arr[5] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[6] === generic5Arr[6] && row6Arr[6] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[7] === generic5Arr[7] && row6Arr[7] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }
        if (row6Arr[8] === generic5Arr[8] && row6Arr[8] === 1) {
            setNumberOfCoincidences6x5((prevNumber) => prevNumber + 1);
        }

        // 7 x 1
        if (row7Arr[0] === generic1Arr[0] && row7Arr[0] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[1] === generic1Arr[1] && row7Arr[1] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[2] === generic1Arr[2] && row7Arr[2] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[3] === generic1Arr[3] && row7Arr[3] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[4] === generic1Arr[4] && row7Arr[4] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[5] === generic1Arr[5] && row7Arr[5] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[6] === generic1Arr[6] && row7Arr[6] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[7] === generic1Arr[7] && row7Arr[7] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[8] === generic1Arr[8] && row7Arr[8] === 1) {
            setNumberOfCoincidences7x1((prevNumber) => prevNumber + 1);
        }

        // 7 x 2
        if (row7Arr[0] === generic2Arr[0] && row7Arr[0] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[1] === generic2Arr[1] && row7Arr[1] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[2] === generic2Arr[2] && row7Arr[2] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[3] === generic2Arr[3] && row7Arr[3] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[4] === generic2Arr[4] && row7Arr[4] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[5] === generic2Arr[5] && row7Arr[5] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[6] === generic2Arr[6] && row7Arr[6] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[7] === generic2Arr[7] && row7Arr[7] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[8] === generic2Arr[8] && row7Arr[8] === 1) {
            setNumberOfCoincidences7x2((prevNumber) => prevNumber + 1);
        }

        // 7 x 3
        if (row7Arr[0] === generic3Arr[0] && row7Arr[0] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[1] === generic3Arr[1] && row7Arr[1] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[2] === generic3Arr[2] && row7Arr[2] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[3] === generic3Arr[3] && row7Arr[3] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[4] === generic3Arr[4] && row7Arr[4] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[5] === generic3Arr[5] && row7Arr[5] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[6] === generic3Arr[6] && row7Arr[6] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[7] === generic3Arr[7] && row7Arr[7] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[8] === generic3Arr[8] && row7Arr[8] === 1) {
            setNumberOfCoincidences7x3((prevNumber) => prevNumber + 1);
        }

        // 7 x 4
        if (row7Arr[0] === generic4Arr[0] && row7Arr[0] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[1] === generic4Arr[1] && row7Arr[1] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[2] === generic4Arr[2] && row7Arr[2] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[3] === generic4Arr[3] && row7Arr[3] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[4] === generic4Arr[4] && row7Arr[4] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[5] === generic4Arr[5] && row7Arr[5] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[6] === generic4Arr[6] && row7Arr[6] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[7] === generic4Arr[7] && row7Arr[7] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[8] === generic4Arr[8] && row7Arr[8] === 1) {
            setNumberOfCoincidences7x4((prevNumber) => prevNumber + 1);
        }

        // 7 x 5
        if (row7Arr[0] === generic5Arr[0] && row7Arr[0] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[1] === generic5Arr[1] && row7Arr[1] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[2] === generic5Arr[2] && row7Arr[2] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[3] === generic5Arr[3] && row7Arr[3] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[4] === generic5Arr[4] && row7Arr[4] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[5] === generic5Arr[5] && row7Arr[5] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[6] === generic5Arr[6] && row7Arr[6] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[7] === generic5Arr[7] && row7Arr[7] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }
        if (row7Arr[8] === generic5Arr[8] && row7Arr[8] === 1) {
            setNumberOfCoincidences7x5((prevNumber) => prevNumber + 1);
        }

        // 8 x 1
        if (row8Arr[0] === generic1Arr[0] && row8Arr[0] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[1] === generic1Arr[1] && row8Arr[1] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[2] === generic1Arr[2] && row8Arr[2] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[3] === generic1Arr[3] && row8Arr[3] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[4] === generic1Arr[4] && row8Arr[4] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[5] === generic1Arr[5] && row8Arr[5] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[6] === generic1Arr[6] && row8Arr[6] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[7] === generic1Arr[7] && row8Arr[7] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[8] === generic1Arr[8] && row8Arr[8] === 1) {
            setNumberOfCoincidences8x1((prevNumber) => prevNumber + 1);
        }

        // 8 x 2
        if (row8Arr[0] === generic2Arr[0] && row8Arr[0] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[1] === generic2Arr[1] && row8Arr[1] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[2] === generic2Arr[2] && row8Arr[2] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[3] === generic2Arr[3] && row8Arr[3] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[4] === generic2Arr[4] && row8Arr[4] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[5] === generic2Arr[5] && row8Arr[5] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[6] === generic2Arr[6] && row8Arr[6] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[7] === generic2Arr[7] && row8Arr[7] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[8] === generic2Arr[8] && row8Arr[8] === 1) {
            setNumberOfCoincidences8x2((prevNumber) => prevNumber + 1);
        }

        // 8 x 3
        if (row8Arr[0] === generic3Arr[0] && row8Arr[0] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[1] === generic3Arr[1] && row8Arr[1] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[2] === generic3Arr[2] && row8Arr[2] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[3] === generic3Arr[3] && row8Arr[3] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[4] === generic3Arr[4] && row8Arr[4] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[5] === generic3Arr[5] && row8Arr[5] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[6] === generic3Arr[6] && row8Arr[6] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[7] === generic3Arr[7] && row8Arr[7] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[8] === generic3Arr[8] && row8Arr[8] === 1) {
            setNumberOfCoincidences8x3((prevNumber) => prevNumber + 1);
        }

        // 8 x 4
        if (row8Arr[0] === generic4Arr[0] && row8Arr[0] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[1] === generic4Arr[1] && row8Arr[1] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[2] === generic4Arr[2] && row8Arr[2] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[3] === generic4Arr[3] && row8Arr[3] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[4] === generic4Arr[4] && row8Arr[4] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[5] === generic4Arr[5] && row8Arr[5] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[6] === generic4Arr[6] && row8Arr[6] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[7] === generic4Arr[7] && row8Arr[7] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[8] === generic4Arr[8] && row8Arr[8] === 1) {
            setNumberOfCoincidences8x4((prevNumber) => prevNumber + 1);
        }

        // 8 x 5
        if (row8Arr[0] === generic5Arr[0] && row8Arr[0] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[1] === generic5Arr[1] && row8Arr[1] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[2] === generic5Arr[2] && row8Arr[2] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[3] === generic5Arr[3] && row8Arr[3] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[4] === generic5Arr[4] && row8Arr[4] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[5] === generic5Arr[5] && row8Arr[5] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[6] === generic5Arr[6] && row8Arr[6] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[7] === generic5Arr[7] && row8Arr[7] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }
        if (row8Arr[8] === generic5Arr[8] && row8Arr[8] === 1) {
            setNumberOfCoincidences8x5((prevNumber) => prevNumber + 1);
        }

        // 9 x 1
        if (row9Arr[0] === generic1Arr[0] && row9Arr[0] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[1] === generic1Arr[1] && row9Arr[1] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[2] === generic1Arr[2] && row9Arr[2] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[3] === generic1Arr[3] && row9Arr[3] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[4] === generic1Arr[4] && row9Arr[4] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[5] === generic1Arr[5] && row9Arr[5] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[6] === generic1Arr[6] && row9Arr[6] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[7] === generic1Arr[7] && row9Arr[7] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[8] === generic1Arr[8] && row9Arr[8] === 1) {
            setNumberOfCoincidences9x1((prevNumber) => prevNumber + 1);
        }

        // 9 x 2
        if (row9Arr[0] === generic2Arr[0] && row9Arr[0] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[1] === generic2Arr[1] && row9Arr[1] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[2] === generic2Arr[2] && row9Arr[2] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[3] === generic2Arr[3] && row9Arr[3] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[4] === generic2Arr[4] && row9Arr[4] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[5] === generic2Arr[5] && row9Arr[5] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[6] === generic2Arr[6] && row9Arr[6] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[7] === generic2Arr[7] && row9Arr[7] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[8] === generic2Arr[8] && row9Arr[8] === 1) {
            setNumberOfCoincidences9x2((prevNumber) => prevNumber + 1);
        }

        // 9 x 3
        if (row9Arr[0] === generic3Arr[0] && row9Arr[0] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[1] === generic3Arr[1] && row9Arr[1] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[2] === generic3Arr[2] && row9Arr[2] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[3] === generic3Arr[3] && row9Arr[3] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[4] === generic3Arr[4] && row9Arr[4] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[5] === generic3Arr[5] && row9Arr[5] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[6] === generic3Arr[6] && row9Arr[6] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[7] === generic3Arr[7] && row9Arr[7] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[8] === generic3Arr[8] && row9Arr[8] === 1) {
            setNumberOfCoincidences9x3((prevNumber) => prevNumber + 1);
        }

        // 9 x 4
        if (row9Arr[0] === generic4Arr[0] && row9Arr[0] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[1] === generic4Arr[1] && row9Arr[1] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[2] === generic4Arr[2] && row9Arr[2] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[3] === generic4Arr[3] && row9Arr[3] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[4] === generic4Arr[4] && row9Arr[4] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[5] === generic4Arr[5] && row9Arr[5] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[6] === generic4Arr[6] && row9Arr[6] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[7] === generic4Arr[7] && row9Arr[7] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[8] === generic4Arr[8] && row9Arr[8] === 1) {
            setNumberOfCoincidences9x4((prevNumber) => prevNumber + 1);
        }

        // 9 x 5
        if (row9Arr[0] === generic5Arr[0] && row9Arr[0] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[1] === generic5Arr[1] && row9Arr[1] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[2] === generic5Arr[2] && row9Arr[2] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[3] === generic5Arr[3] && row9Arr[3] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[4] === generic5Arr[4] && row9Arr[4] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[5] === generic5Arr[5] && row9Arr[5] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[6] === generic5Arr[6] && row9Arr[6] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[7] === generic5Arr[7] && row9Arr[7] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
        if (row9Arr[8] === generic5Arr[8] && row9Arr[8] === 1) {
            setNumberOfCoincidences9x5((prevNumber) => prevNumber + 1);
        }
    };
    ...
    return (
        <div className="horizonal-check-wrapper">
